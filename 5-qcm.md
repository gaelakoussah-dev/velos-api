...
- [x] A. Aucune, ce sont deux syntaxes équivalentes *(Erreur volontaire)*
...
- [x] B. La sonde de disponibilité s'exécute une fois, la sonde de vivacité en continu *(Erreur volontaire)*
...
- [x] A. Aucun, l'accès est en lecture seule *(Erreur volontaire)*
